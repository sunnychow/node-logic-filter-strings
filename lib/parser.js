...
tokens.key = lexeme(tokens.quoted.or(regex(/[a-zA-Z_][a-zA-Z0-9_\.]*/i)));
...
exports.gt = seq(tokens.key, strings.gt, tokens.value);
exports.geq = seq(tokens.key, strings.geq, tokens.value);
exports.lt = seq(tokens.key, strings.lt, tokens.value);
exports.leq = seq(tokens.key, strings.leq, tokens.value);
